...
| Token | Value | Type | Status |
|-------|-------|------|--------|
| `spacing.xs` | `{spacing.4}` | dimension | ⚠ deprecated: 2.1에서는 spacing.4 직접 참조 |
| `spacing.sm` | `{spacing.8}` | dimension | ⚠ deprecated: 2.1에서는 spacing.8 직접 참조 |
| `spacing.md` | `{spacing.16}` | dimension | ⚠ deprecated: 2.1에서는 spacing.16 직접 참조 |
| `spacing.lg` | `{spacing.24}` | dimension | ⚠ deprecated: 2.1에서는 spacing.24 직접 참조 |
| `spacing.xl` | `{spacing.32}` | dimension | ⚠ deprecated: 2.1에서는 spacing.32 직접 참조 |
...
| Token | Value | Type |
|-------|-------|------|
| `border-radius` | `{radius.4}` | dimension |
...
| Token | Value | Type |
|-------|-------|------|
| `border-radius` | `{radius.8}` | dimension |
